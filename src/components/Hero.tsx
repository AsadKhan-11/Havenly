    ...
    <section ref={ref} className="relative h-screen w-full overflow-hidden bg-obsidian">
      ...
      >
        ...
        >
          <Link
            href="/properties"
            className="group relative inline-flex items-center gap-3 px-10 py-4 rounded-full border border-gold bg-obsidian/40 backdrop-blur-md text-pearl uppercase tracking-[0.2em] text-[11px] font-medium overflow-hidden transition-all duration-500 hover:bg-gold hover:text-obsidian hover:shadow-[0_0_30px_rgba(212,175,55,0.25)]"
          >
